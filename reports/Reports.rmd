...
```{r, echo=FALSE, out.width="100%", fig.cap="Overall sentiments of learners"}
...
```{r, echo=FALSE, out.width="100%", fig.cap="Overall sentiment scores of learners"}
...
syuzhet package for NLP: https://cran.r-project.org/web/packages/syuzhet/vignettes/syuzhet-vignette.html
Video length research: https://www.techsmith.com/blog/video-length/
Sentiment Extraction Methods: https://www.tidytextmining.com/sentiment.html